...
func (api *EventsService) ListEvents(ctx context.Context, params ListEventsRequestParams) (*shared.MagicbellProjectClientResponse[ArrayOfEvents], *shared.MagicbellProjectClientError) {
	config := *api.getConfig()
